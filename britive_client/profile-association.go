...
func (c *Client) SaveProfileAssociationScopes(ctx context.Context, profileID string, associations []ProfileAssociation) error {

	url := fmt.Sprintf("%s/paps/%s/scopes", c.APIBaseURL, profileID)
	_, err := c.Post(ctx, url, associations, ProfileLockName)
	if err != nil {
		return err
	}
...
func (c *Client) SaveProfileAssociationResourceScopes(ctx context.Context, profileID string, associations []ProfileAssociation) error {
	url := fmt.Sprintf("%s/paps/%s/resources/scopes", c.APIBaseURL, profileID)
	_, err := c.Post(ctx, url, associations, ProfileLockName)
	if err != nil {
		return err
	}
...
func (c *Client) GetProfileAssociationResourceByNativeID(ctx context.Context, profileID string, nativeID string) (*ProfileAssociationResource, error) {
...
func (c *Client) GetEnvId(ctx context.Context, appContainerID string, accountId string) string {
