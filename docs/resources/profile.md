...
```sh
terraform import britive_profile.new apps/app-container-id/{{app_container_id}}/paps/{{name}}
terraform import britive_profile.new app-container-id/{{app_container_id}}/{{name}}
