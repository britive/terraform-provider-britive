...
layout: "britive"
page_title: "britive_resource_manager_profile_policy_prioritization Resource - britive"
description: |-
  Manages policy priority configuration for a Britive resource manager profile.
---

# britive_resource_manager_profile_policy_prioritization Resource
...
```hcl
resource "britive_resource_manager_profile_policy_prioritization" "new_priority" {
...
* `profile_id` - (Required) The identity of britive resource manager profile.
...
```sh
terraform import britive_resource_manager_profile_policy_prioritization.new resource-manager/{{profile_id}}/policies/priority
terraform import britive_resource_manager_profile_policy_prioritization.new {{profile_id}}
```
