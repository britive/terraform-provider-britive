...
func TestAccBritiveResourceManagerResourceBrokerPools(t *testing.T) {
...
func testAccCheckBritiveResourceResourceBrokerPoolExists(resourceName string) resource.TestCheckFunc {
